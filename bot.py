...
async def cmd_start(message: types.Message):
    ...
    # создаём отделы при первом запуске и добавляем недостающие
    ...
    if BALIZAG_CHAT_ID:
        try:
            ...
            text = (
                ...
                f"🤖 Перейти в бота: @BalisageAudit_80_bot"
            )
